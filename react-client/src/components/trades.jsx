    ...
    this.state = {
      trades: [
        ...
        },
        {
          id: 2,
          username1: 'Hayden',
          food_id1: '(OFFERED BY HAYDEN)',
          username1_latitude: 37.782206,
          username1_longitude: -122.409892,
          username2: 0,
          username2_latitude: 0,
          username2_longitude: 0,
          food_id2: '(OFFERED BY RESPONSE NOT ON TIME)',
          rating: 0,
          time: '2018-01-17T22:31:16+00:00',
          response: false,
          expired: false,
    ...
    return (
      <div>
        <div id="trades">
          <h2>Your Trades</h2>
          <ol>
            {console.log('err: ', this.state.trades)}
