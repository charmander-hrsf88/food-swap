...
var LogIn = function (_React$Component) {
  ...
  function LogIn(props) {
    ...
    _this.state = {
      NewUser: true,
      signUpUserName: 'alexchoi',
      signUpPassword: 'alexchoi',
      signUpConfirmPassword: 'alexchoi',
      signUpName: 'Hayden Marx',
      signUpEmail: 'haydenmarx@gmail.com',
      logInUserName: 'alexchoi',
      logInPassword: 'alexchoi'
    };
    _this.switchType = _this.switchType.bind(_this);
  ...
  _createClass(LogIn, [{
    ...
    value: function render() {
      return this.state.NewUser === true ? _react2.default.createElement(
        'div',
        { id: 'logInForm' },
